...
import (
	...
	informers "github.com/rancher/system-upgrade-controller/pkg/generated/informers/externalversions"
...
func (c *Factory) Upgrade() Interface {
	return New(c.controllerManager, c.informerFactory.Upgrade(), c.clientset)
}
